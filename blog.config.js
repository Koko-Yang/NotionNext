...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'While net the points makes you to get high score, it also means you have to link the important points to build a net.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://netthepoints.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Sourcing, resources, connect all points', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:netthepoints@gmail.com process.env.NEXT_PUBLIC_CONTACT_EMAIL || '', // 邮箱地址 例如mail@tangly1024.com
